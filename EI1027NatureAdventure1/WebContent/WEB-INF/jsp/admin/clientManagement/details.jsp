			...
			<div class="modal fade" id="emailModal" tabindex='-1' role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<form:form id="emailForm" method="post" modelAttribute="email" role="form" action="${pageContext.request.contextPath}/admin/clientManagement/details/${cli.clientId}/sendmail.html">
