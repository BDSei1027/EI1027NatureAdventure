...
<jsp:body>
	...
	<div id="actionsHelp" class="row">
		<div id="action" class="col-lg-2">
			<ul class="nav nav-pills nav-stacked">
				...
				<li class="active"><a href="${pageContext.request.contextPath}/admin/activityManagement/onlyInactive.html">Only inactive</a></li>
		...
		<div id="help" class="col-lg-10">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<p>The following table lists only the inactive activities.</p>
	...
	<h6 class="subtitle">List of the inactive activities</h6>
	<t:tablaActivity />
