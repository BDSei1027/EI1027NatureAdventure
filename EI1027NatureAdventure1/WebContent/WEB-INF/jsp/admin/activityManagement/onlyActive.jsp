...
<jsp:body>
	...
	<div id="actionsHelp" class="row">
		<div id="action" class="col-lg-2">
			<ul class="nav nav-pills nav-stacked">
				...
				<li class="active"><a href="${pageContext.request.contextPath}/admin/activityManagement/onlyActive.html"><fmt:message key="admin.activitymanage.menu.active" /></a>
		...
		<div id="help" class="col-lg-10">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<p><fmt:message key="admin.activitymanage.onlyActive.text1" /></p>
	...
	<h6 class="subtitle"><fmt:message key="admin.activitymanage.onlyActive.subtitle" /></h6>
	<t:tablaActivity />
