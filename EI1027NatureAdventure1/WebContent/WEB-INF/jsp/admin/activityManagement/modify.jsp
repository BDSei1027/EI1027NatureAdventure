	...
	<form:form method="post" modelAttribute="activity" role="form">
		...
		<div class="text-center">
			<div class="btn-group">
				...
				<c:if test="${not activity.isActive()}"><a href="${pageContext.request.contextPath}/admin/activityManagement/enable/${activity.idAct}"><button type="button" class="btn btn-success">Set active</button></a></c:if>
			</div>
		</div>
	</form:form>
</jsp:body>
