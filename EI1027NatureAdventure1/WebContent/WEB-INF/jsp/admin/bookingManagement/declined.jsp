	...
	<div id="actionsHelp" class="row">
		<div id="action" class="col-lg-2">
			<ul class="nav nav-pills nav-stacked">
				...
				<li class="active"><a href="${pageContext.request.contextPath}/admin/bookingManagement/declined.html">Declined</a></li>
			</ul>
		</div>
		<div id="help" class="col-lg-10">
			<div class="panel panel-info">
				...
				<div class="panel-body">
					<p>The following table lists only the declined bookings.</p>
