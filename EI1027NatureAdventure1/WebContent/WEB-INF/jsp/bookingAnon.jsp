...
<jsp:body>
	...
	<div class="panel-body">
		<form:form modelAttribute="clientBookingEnvelope" action="${pageContext.request.contextPath}/activities/createBooking/${activity.idAct}.html" method="post" role="form">
			...
			<div class="form-group row">
				<form:label path="name" class="col-lg-3 control-label"><fmt:message key="booking.book.namecli" /></form:label>
				<div class="col-lg-9">
			...
			<div class="form-group row">
				<form:label path="lastName" class="col-lg-3 control-label"><fmt:message key="booking.book.lastcli" /></form:label>
				<div class="col-lg-9">
			...
			<div class="form-group row">
				<form:label path="email" class="col-lg-3 control-label"><fmt:message key="booking.book.emailcli" /></form:label>
				<div class="col-lg-9">
