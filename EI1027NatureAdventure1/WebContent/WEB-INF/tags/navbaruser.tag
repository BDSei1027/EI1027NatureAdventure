...
<nav class="navbar navbar-inverse" role="navigation">
  ...
  <div class="navbar-collapse collapse">
    ...
    <ul class="nav navbar-nav navbar-right">
      ...
      <li class="active"><a href="${pageContext.request.contextPath}/logout.html" class="btn-logout"><span class="glyphicon glyphicon-user" aria-hidden="true" style="padding-right: 8px;"></span><fmt:message key="nav.logout" /></a>
    </ul>
  </div>
</nav>